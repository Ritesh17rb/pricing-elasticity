...
function addAuditTrail(doc, constraints, timestamp) {
  ...
  const disclaimer = [
    'DISCLAIMER: This analysis is based on a publicly anchored modeled dataset and industry benchmarks.',
    'Results should be validated with business data before implementation.',
    'Elasticity coefficients are calibrated to restaurant pricing and promo benchmarks.',
